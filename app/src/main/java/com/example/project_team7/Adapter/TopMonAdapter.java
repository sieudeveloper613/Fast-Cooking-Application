...
public class TopMonAdapter extends RecyclerView.Adapter<TopMonAdapter.MonAnViewHolder>
{
    private Context mContext;
    private ArrayList<MonAn> MonAnList;
    TopMonFragment activity;
    String type;
    public TopMonAdapter(Context mContext, ArrayList<MonAn> monAnArrayList, TopMonFragment activity, String type) {
